...
java -classpath '../../bin:../../lib/cloudsim-4.0.jar:../../lib/commons-math3-3.6.1.jar:../../lib/colt.jar' edu.boun.edgecloudsim.applications.sample_app5.MainApp ${scenario_conf_file} ${scenario_edge_devices_file} ${scenario_applications_file} ${scenario_out_folder} ${iteration_number} > ${scenario_out_folder}.log
